...
namespace affine_transformations2D
{
    public partial class Form1 : Form
    {
        ...
        bool is_point_inside(List<Point> polygon, Point p)
        {
            ...
            bool is_contains_corners = false;
            List<PointF> inter_points = new List<PointF>();
            ...
            do
            {
                ...
                if (intersection.X != -1)
                {
                    ...
                    if (inter_points.Contains(intersection))
                        is_contains_corners = true;
                    else
            ...
            if (inter_points.Count() == 1 && is_contains_corners)
                if (extreme.Y == maxPolygonCoord.Y || extreme.Y == minPolygonCoord.Y)
                    return false;

            // Return true if count is odd, false otherwise
            return inter_points.Count() % 2 == 1;
        }
